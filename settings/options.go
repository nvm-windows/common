...
type Settings struct {
	...
	AutoInstall               bool     `cfg:"auto_install" reg:"AutoInstall" default:"false" help:"Automatically install missing auto-detected version (shim-only)."`
	DisableUpgrade            bool     `cfg:"disable_upgrade" reg:"DisableUpgrade" default:"false" help:"Disable nvm upgrades." hidden:"true"`
	AllowInsecureDownloads    bool     `cfg:"allow_insecure_downloads" reg:"AllowInsecureDownloads" default:"true" help:"Allow expired/invalid SSL certificates when downloading assets." hidden:"true"`
