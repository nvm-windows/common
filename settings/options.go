...
type Settings struct {
	...
	TrustedModules               []string `cfg:"trusted_modules" reg:"TrustedModules" help:"Trust firewall: modules allowed to auto-reshim after self-update. NOT/! negation; empty defaults to NOT ALL. May be a single HTTPS policy URL." hidden:"true"`
	UntrustedModuleHandlerAction string   `cfg:"untrusted_module_handler_action" reg:"UntrustedModuleHandlerAction" default:"deny" enum:"deny,prompt" help:"Action when a global module changes without TrustedModules hit: deny (default) or prompt." hidden:"true"`
